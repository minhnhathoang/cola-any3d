...
import util.error.util.AssertUtils;
 ...
 * @since 2.4.13
 */
public class ClientAssert extends Assert {

    public static void notNull(Object object, @NonNull BaseException baseException) {
        try {
